...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        $().ready(function () {
            CKEDITOR.replace('ctl00_body_txtA', { toolbar: 'SlickTicket' });
            $('#divPopup').jqm();
            $('#divPopup').jqmAddTrigger($('#aNewQ'));
        });
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    <fieldset class="inner_color">
        ...
        <h2>
            <a href="javascript:void();" class="smaller right" id="aNewQ">
                <asp:Label ID="lblNewQuestion" runat="server" meta:resourcekey="btnNewResource1" ></asp:Label>
            </a>
...
<%--    <ajax:ModalPopupExtender ID="mpe" runat="server" TargetControlID="btnNew" 
    ...
    <%--<asp:Panel ID="pnlNew" runat="server" style="display:none;" >--%>
        <div id="divPopup" class="jqmWindow">
            <fieldset class="inner_color">
                <h3>
