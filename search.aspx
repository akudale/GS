            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="pnlSearch" runat="server" DefaultButton="btnSearch" 
                    ...
                    <table class="by2">
                        ...
                        <tr>
                            <td>
                                <h3><span class="title_header"><asp:literal runat="server" ID="Literal1" text="Membership Code" /></span>&nbsp;</h3>
                                <asp:TextBox ID="txtMembershipCode" runat="server"  CssClass="half_table" />
                    ...
                    <asp:GridView ID="gvResults" runat="server" AutoGenerateColumns="False"  CssClass="list" GridLines="None" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField SortExpression="title" meta:resourcekey="TemplateFieldResource2">
                                <ItemTemplate>
                                    <a class="tooltip large" href="ticket.aspx?ticketID=<%# Eval("id") %>&orderno=<%# Eval("Order_no") %>">
                                        ...
                                        <span class='border_color'><q class='inner_color base_text'>
                                            ...
                                            <div><b><%= Resources.Common.TicketNumber %> </b><%# Eval("Order_no") %></div>
